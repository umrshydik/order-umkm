...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl mx-auto">
    <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $permission->name) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
            <p class="text-xs text-gray-500 mt-2">Gunakan format "aksi namemenu" agar dapat terkelompokkan dengan baik pada menu Manajemen Hak Akses. (Contoh: "view data pesanan")</p>
